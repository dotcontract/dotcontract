...
// This class defines a complete generic visitor for a parse tree produced by ModalityParser.

export default class ModalityVisitor extends antlr4.tree.ParseTreeVisitor {

	// Visit a parse tree produced by ModalityParser#expression.
	visitExpression(ctx) {
	...
	// Visit a parse tree produced by ModalityParser#emptyDiamondFormula.
	...
	// Visit a parse tree produced by ModalityParser#orFormula.
	visitOrFormula(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by ModalityParser#canMacro.
	visitCanMacro(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by ModalityParser#trueArg.
	visitTrueArg(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by ModalityParser#falseArg.
	visitFalseArg(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by ModalityParser#stringArg.
	visitStringArg(ctx) {
	  return this.visitChildren(ctx);
	}
